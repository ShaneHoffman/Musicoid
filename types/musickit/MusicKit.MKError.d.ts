declare namespace MusicKit {
  /**
   * MusicKit on the Web uses the following error codes to describe errors that may occur when using MusicKit,
   * including server and local errors.
   */
  class MKError extends Error {
    /**
     * Error code indicating that you don't have permission to access the endpoint, MediaItem, or content.
     */
    ...
    /**
     * Error code indicating a MusicKit on the Web configuration error.
     */
     ...
     */
    static CONTENT_UNSPPORTED: string;
    /**
    ...
    /**
     * Error code indicating that the MediaItem descriptor is invalid.
     */
     ...
     */
    static PLAYREADY_CBC_ENCRYPTYION_ERROR: string;
    /**
    ...
    /**
     * Error code indicating that the request wasn’t accepted because its authorization
     * is missing or invalid due to an issue with the developer token.
     */
    ...
    /**
     * Error code indicating that playback of media content requires user interaction
     * first and cannot be automatically started on page load. For more information, see HTMLMediaElement.play().
     */
    static USER_INTERACTION_REQUIRED: string;
    /**
     * Error code indicating that the browser's Widevine CDM implementation is old and insecure,
     * and Irdeto won't serve a license for it.
     */
